...
gapminder %>% 
  ...
  mutate(life_level = case_when(lifeExp < 23 ~ "very low",
                                ...
                                lifeExp < 59 ~ "moderate",
                                lifeExp < 70 ~ "high",
                                TRUE ~ "very high")) %>%  #True ~ for everything else
...
- How many levels? What are they? levels ( ) : 5 - "Africa"   "Americas" "Asia"     "Europe"   "Oceania" 
...
gapminder %>%
  ggplot() +
  geom_bar(aes(fct_infreq(continent))) +  #fct_rev() for opposite-order
  coord_flip()+
  theme_bw() +
  ylab("Number of entries") + xlab("Continent")
```
